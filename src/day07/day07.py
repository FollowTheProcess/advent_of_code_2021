...
They seem to be preparing to blast a hole in the ocean floor; sensors indicate a massive underground cave
...
for your submarine to get through.
...
Crab submarines have limited fuel, so you need to find a way to make all of their horizontal positions
...
def find_cheapest_fuel_use(positions: list[int]) -> int:
    """
